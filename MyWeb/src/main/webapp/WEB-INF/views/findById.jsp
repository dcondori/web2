					...
					<p>
						<form:form name="" modelAttribute="alumno" method="post">
							<div class="form-group">
					            ...
					            <div class="row">
					            	<div class="col-md-6">
					            		<form:input class="form-control" path="id_alumno" autofocus="autofocus" placeholder="Id Alumno:"/>
					            	</div>
					            	<div class="col-md-3">
					            		<button type="submit" name="btnBuscar" class="btn btn-block btn-success">Buscar</button>
					            	</div>
					            </div>					            
					        </div>
					        ...
					        <div class="row">
					        	...
					        	<div class="col-md-3">
					        		<button type="submit" name="btnEliminar" onclick="return confirmDelete()" class="btn btn-block btn-danger">Eliminar</button>
					        	</div>
					        	<div class="col-md-3">
